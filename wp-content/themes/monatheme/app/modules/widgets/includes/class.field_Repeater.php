        ...
        foreach ( $field_args['fields'] as $key => $item ) {
            ...
            if ( $item['type'] == 'text' ) {
                ...
                if ( isset ( $item['title'] ) ) {
                    ...
                    $item_title = __( 'True / False', 'monamedia' );
                }

                if ( isset ( $item['class'] ) ) {
                    $class = 'class="mona-custom-widget ref-field-truefalse mona-checkbox-field '.esc_attr( $item['class'] ).'"';
                } else {
                ...
                if ( isset ( $fields ) && ! empty ( $fields ) ) {
                    foreach ( $field_args['fields'] as $k => $field ) {
                        ...
                        if ( $field_args['fields'][$k]['type'] == 'text' ) {
                            ...
                            if ( isset ( $field_args['fields'][$k]['class'] ) ) {
                                $class = 'class="mona-custom-widget ref-field-truefalse mona-checkbox-field '.$field_args['fields'][$k]['class'].'"';
                            } else {
                                $class = 'class="mona-custom-widget ref-field-truefalse mona-checkbox-field"';
                            }
                            ...
                            $output .= '<label for="'.$for.'" class="mona-checkbox-label"></label>';
                            $output .= '</div>';
                            $output .= '</div>';
                            $output .= '</div>';
                            $output .= '</div>';
