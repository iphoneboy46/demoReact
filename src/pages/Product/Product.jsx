...
const Product = () => {
    ...
    const renderChildren = (children, activeDmChild, setActiveDmChild, setTitleSlDm, setIdCate, setCateQuantity) => {
        return (
                        ...
                        <li key={childIndex} className="box-select-item">
                            <div
                                ...
                                onClick={() => {
                                    ...
                                    setCateQuantity(child.node?.count);
                                    localStorage.setItem("titleSlDm", child.node.name);
                                    localStorage.setItem("activeDm", "");
                                    localStorage.setItem("activeDmChild", child.node.termTaxonomyId);
                                }}
                            >
                            ...
                            {child.node?.children?.edges?.length > 0 && renderChildren(child.node.children.edges, activeDmChild, setActiveDmChild, setTitleSlDm, setIdCate, setCateQuantity)}
                        </li>
                    );
                })}
            </ul>
                                                                    ...
                                                                    <li key={index} className="box-select-item">
                                                                        <div
                                                                            ...
                                                                            onClick={() => {
                                                                                ...
                                                                                localStorage.setItem("activeDm", data.node.termTaxonomyId);
                                                                        ...
                                                                        {/* Kiểm tra nếu có cấp con, tiếp tục gọi hàm đệ quy */}
                                                                        {data.node?.children?.edges?.length > 0 && renderChildren(data.node.children.edges, activeDmChild, setActiveDmChild, setTitleSlDm, setIdCate, setCateQuantity)}
                                                                    </li>
                                                                );
                                                            })}
                                                        </ul>
